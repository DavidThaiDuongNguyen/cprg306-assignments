...
export default function Page() {
  ...
  return (
    <main className="p-5 text-center">
      <h1 className="text-3xl font-bold mb-6">Week 10 - Login</h1>
      ...
      {user && (
        <div className="space-y-3">
          ...
          <div className="flex justify-center gap-4 mt-2">
            <Link href="/week-10/shopping-list" className="w-50 bg-blue-500 hover:bg-blue-300 text-white px-5 py-3 rounded text-center">
              Shopping List
            </Link>

            <Link href="/week-10/profile" className="w-50 bg-green-500 hover:bg-green-300 text-white px-5 py-3 rounded text-center">
              Profile
            </Link>
          </div>
